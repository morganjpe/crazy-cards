...
const Form = ({ setEligibilityCheck }) => {
  ...
  return (
    <Form.Container onSubmit={handleSubmit(submit)}>
      <Form.Group>
        <div>
      ...
      <Form.Group>
        ...
        {errors.postcode && <Form.Error>Please check your postcode</Form.Error>}
      </Form.Group>
...
Form.Radio = styled.div`
  ...
  input:checked ~ .label-button {
    ${tw`border-blue-400 bg-blue-100 text-blue-500`}
  }
`;
